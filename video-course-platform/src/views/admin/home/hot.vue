...
import { getAllHotTopics, deleteHotTopic, toggleHotTopicStatus, type HotTopic } from '@/utils/news-storage';
import HotDrawer from './components/HotDrawer.vue';
