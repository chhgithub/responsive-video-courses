...
function handleDelete(row: IntroductionContent) {
  ElMessageBox.confirm('确定要删除这条内容吗？', '提示', {
    ...
    .then(() => {
      ...
      if (index !== -1) {
        introList.value.splice(index, 1);
      }
...
<template>
  <div class="intro-management">
    ...
    <el-card class="toolbar-card" shadow="never">
      <el-button type="primary" @click="handleAdd">新增课程介绍</el-button>
    </el-card>
